(function () {
  ...
  var css = `
    ...
    .atp-header-title { font-size: 13px; font-weight: 700; font-family: 'Syne', sans-serif; color: var(--text, #F0F4FF); }
    ...
    .atp-u-av { width: 42px; height: 42px; border-radius: 50%; flex-shrink: 0; background: linear-gradient(135deg, var(--purple, #9B6BFF), var(--blue, #4D9FFF)); display: flex; align-items: center; justify-content: center; font-size: 15px; font-weight: 700; font-family: 'Syne', sans-serif; color: #fff; }
    .atp-u-name { font-size: 13px; font-weight: 700; color: var(--text, #F0F4FF); font-family: 'Syne', sans-serif; }
